...
module.exports.CreateCommissionService = async ({ dataVenda, mes, ano, vendedor, status, cliente, mixProdutos, tipoProduto, multiplicador, markup, vendaAvulsa, valorBase, valorVendido }) => {
